  ...
  en: {
    ...
    settings: {
      ...
      ai: {
        ...
        webSearchDesc: 'Used by the AI websearch tool for current information.',
    ...
    aiSidebar: {
      ...
      readAction: 'Read terminal output', webSearchAction: 'Web search: {q}', confirmDeleteShort: 'Delete?',
    },
  },
  ...
  'zh-CN': {
    ...
    settings: {
      ...
      ai: {
        ...
        webSearchDesc: '供 AI 的 websearch 工具获取实时信息使用。',
    ...
    aiSidebar: {
      ...
      readAction: '读取终端输出', webSearchAction: '网页搜索：{q}', confirmDeleteShort: '删除？',
    },
  },
  ...
  'zh-TW': {
    ...
    settings: {
      ...
      ai: {
        ...
        webSearchDesc: '供 AI 的 websearch 工具取得即時資訊使用。',
    ...
    aiSidebar: {
      ...
      readAction: '讀取終端機輸出', webSearchAction: '網頁搜尋：{q}', confirmDeleteShort: '刪除？',
    },
  },
};
