...
const dict = {
  en: {
    ...
    aiSidebar: {
      ...
      readAction: 'Read terminal output', openURLAction: 'Open URL: {url}', confirmDeleteShort: 'Delete?',
  ...
  'zh-CN': {
    ...
    aiSidebar: {
      ...
      readAction: '读取终端输出', openURLAction: '打开 URL：{url}', confirmDeleteShort: '删除？',
  ...
  'zh-TW': {
    ...
    aiSidebar: {
      ...
      readAction: '讀取終端機輸出', openURLAction: '開啟 URL：{url}', confirmDeleteShort: '刪除？',
