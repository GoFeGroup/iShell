...
const dict = {
  en: {
    ...
    profileForm: {
      ...
      pfTitle: '⇄ Port Forwarding', pfType: 'Type', pfLocal: 'Local', pfRemote: 'Remote', pfDynamic: 'Dynamic (SOCKS)',
    ...
    portForward: {
      title: '⇄ Port Forwarding', adhocTitle: 'Ad-hoc tunnel', adhocHint: '(not saved)',
    ...
    aiSidebar: {
      ...
      readAction: 'Read terminal output', openURLAction: 'Open URL: {url}',
      readLocalFileAction: 'Read file: {path}', listLocalDirAction: 'List directory: {path}', confirmDeleteShort: 'Delete?',
  ...
  'zh-CN': {
    ...
    profileForm: {
      ...
      pfTitle: '⇄ 端口转发', pfType: '类型', pfLocal: '本地', pfRemote: '远程', pfDynamic: '动态（SOCKS）',
    ...
    portForward: {
      title: '⇄ 端口转发', adhocTitle: '临时隧道', adhocHint: '（不保存）',
    ...
    aiSidebar: {
      ...
      readAction: '读取终端输出', openURLAction: '打开 URL：{url}',
      readLocalFileAction: '读取文件：{path}', listLocalDirAction: '列出目录：{path}', confirmDeleteShort: '删除？',
  ...
  'zh-TW': {
    ...
    profileForm: {
      ...
      pfTitle: '⇄ 連接埠轉發', pfType: '類型', pfLocal: '本機', pfRemote: '遠端', pfDynamic: '動態（SOCKS）',
    ...
    portForward: {
      title: '⇄ 連接埠轉發', adhocTitle: '臨時通道', adhocHint: '（不儲存）',
    ...
    aiSidebar: {
      ...
      readAction: '讀取終端機輸出', openURLAction: '開啟 URL：{url}',
      readLocalFileAction: '讀取檔案：{path}', listLocalDirAction: '列出目錄：{path}', confirmDeleteShort: '刪除？',
